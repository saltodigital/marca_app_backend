...
class Proyecto(BaseModel):
    ...
    estado = models.ForeignKey(Estado , related_name = 'f_Estado_proyecto_estado' , on_delete=models.PROTECT ,null = True , blank = True)
    valorAdjudicado = models.FloatField(null = True , blank = True)
    latitud = models.FloatField()
    longitud = models.FloatField()
    tipo = models.ForeignKey(Tipo , related_name = 'f_P_tipo_proyecto' , on_delete=models.PROTECT, null = True , blank = True)
